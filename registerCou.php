...
# Validate lastname ....
    ...
    if (count($errors) > 0) {
        ...
        if (move_uploaded_file($temPath, $disPath)) {
            ...
            $sql = "insert into users (Fname,Lname,address,email,password,id_role,phone,image,Start_Join_date) values ('$Fname','$Lname','$address','$email','$password',6,'$phone','$FinalName','$join_date')";
            $op  = doQuery($sql);
...
<main>
    <div class="container-fluid">
        <h1 class="mt-4 alert alert-light">Register As Courier</h1>
...
<div class="row">
<div class="col"><img src="assets/4.jpeg" width="90%" height="70%"/></div>

<div class="col"> <form action="<?php echo   htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" enctype="multipart/form-data">
