...
# Validate lastname ....
    ...
    if (count($errors) > 0) {
        ...
        if (move_uploaded_file($temPath, $disPath)) {
            ...
            $sql = "insert into users (Fname,Lname,address,email,password,id_role,phone,image,Start_Join_date) values ('$Fname','$Lname','$address','$email','$password',2,'$phone','$FinalName','$join_date')";
            $op  = doQuery($sql);
...
<main>
    <div class="container-fluid">
        ...
        <h1 class="mt-4">Register As Company</h1>
...
<div class="col">
<img src="assets/1.jpeg" width="90%" height="50%"/></div>
</div>
